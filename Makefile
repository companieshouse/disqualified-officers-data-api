artifact_name       := disqualified-officers-data-api
version             := "unversioned"
...
dependency-check:
	...
	DEPENDENCY_CHECK_SUPPRESSIONS_HOME="$${suppressions_home}" "$${suppressions_home}/scripts/depcheck" --repo-name=disqualified-officers-data-api
